...
namespace Presentacion
{
    public partial class contProvidenciaSuspension : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string _cargo_abogado = "";
            string _cargo_secretario = "";
            int _id_usuario_secretario = 0;
            int _id_usuario_abogado = 0;
            ...
            string columnas = "juicios.id_juicios, juicios.juicio_referido_titulo_credito, clientes.identificacion_clientes, clientes.nombres_clientes, clientes.identificacion_garantes, clientes.nombre_garantes, provincias.nombre_provincias, titulo_credito.numero_titulo_credito, juicios.fecha_emision_juicios, juicios.cuantia_inicial, juicios.fecha_ultima_providencia, asignacion_secretarios_view.id_abogado, asignacion_secretarios_view.impulsores, asignacion_secretarios_view.id_secretario, asignacion_secretarios_view.secretarios, ciudad.id_ciudad, ciudad.nombre_ciudad , juicios.numero_juicios, asignacion_secretarios_view.cargo_secretarios,  asignacion_secretarios_view.cargo_impulsores, asignacion_secretarios_view.sexo_secretarios ,   asignacion_secretarios_view.sexo_impulsores , clientes.identificacion_clientes_1, clientes.nombre_clientes_1, clientes.identificacion_clientes_2, nombre_clientes_2, identificacion_clientes_3, clientes.nombre_clientes_3, identificacion_garantes_1, nombre_garantes_1, clientes.identificacion_garantes_2, nombre_garantes_2, identificacion_garantes_3, clientes.nombre_garantes_3, correo_clientes, correo_clientes_1, correo_clientes_2, clientes.correo_clientes_3, clientes.direccion_clientes_1, clientes.direccion_clientes_2, clientes.direccion_clientes_3, clientes.cantidad_clientes, clientes.cantidad_garantes   ";
            ...
            string where = " clientes.id_clientes = titulo_credito.id_clientes AND clientes.id_provincias = provincias.id_provincias AND titulo_credito.id_titulo_credito = juicios.id_titulo_credito AND titulo_credito.id_ciudad = ciudad.id_ciudad AND juicios.id_estados_procesales_juicios = estados_procesales_juicios.id_estados_procesales_juicios AND asignacion_secretarios_view.id_abogado = titulo_credito.id_usuarios AND asignacion_secretarios_view.id_abogado = 22  "; 
